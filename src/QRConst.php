...
class QRConst
{
    ...
    /** NOTE: we define constants direct as numbers (we've removed the bit-shiftings here) */
    public const G15_MASK = 21522; // result of: (1 << 14)|(1 << 12)|(1 << 10)|(1 << 4)|(1 << 1)
    public const G15 = 1335;  // result of: (1 << 10)|(1 << 8)|(1 << 5)|(1 << 4)|(1 << 2)|(1 << 1)|(1 << 0)
    public const G18 = 7973;  // result of: (1 << 12)|(1 << 11)|(1 << 10)|(1 << 9)|(1 << 8)|(1 << 5)|(1 << 2)|(1 << 0)
